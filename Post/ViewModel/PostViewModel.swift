...
public final class PostViewModel {
    ...
    public init(postType: PostType = .newCast, content: Content? = nil, page: Page = Page().initCustom(displayName: UserManager.shared.displayName, castcleId: UserManager.shared.rawCastcleId)) {
